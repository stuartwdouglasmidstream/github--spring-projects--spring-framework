...
export PROJECT_VERSION=5.2.10.RELEASE
...
if [ -z "" ]; then
  echo "Enforce version not set, recreating original tag v5.2.10.RELEASE"
  git tag -m v5.2.10.RELEASE -a v5.2.10.RELEASE || true
else
